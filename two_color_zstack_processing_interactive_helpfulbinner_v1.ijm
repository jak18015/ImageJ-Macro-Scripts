...
Dialog.addMessage("Create a comma-separated list of phenotypes to choose from for categorizing the phenotypes in this image set");
Dialog.addString("Phenotypes:", "Cytosolic,");
}
